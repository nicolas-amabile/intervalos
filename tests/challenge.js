...
const ASC_TEST_CASES = [
  ...
  // ['A', FLAT, III, m, ASC, 'C'],
  // ['A', FLAT, III, M, ASC, 'C'],
  // ['A', FLAT, IV, DISMINUIDA, ASC, 'D'],
  // ['A', FLAT, IV, JUSTA, ASC, 'D'],
  // ['A', FLAT, IV, AUMENTADA, ASC, 'D'],
  // ['A', FLAT, V, DISMINUIDA, ASC, 'E'],
  // ['A', FLAT, V, JUSTA, ASC, 'E'],
  ...
  // ['G', FLAT, III, m, ASC, 'B'],
  // ['G', FLAT, III, M, ASC, 'B'],
  // ['G', FLAT, IV, DISMINUIDA, ASC, 'C'],
  // ['G', FLAT, IV, JUSTA, ASC, 'C'],
  // ['G', FLAT, IV, AUMENTADA, ASC, 'C'],
  // ['G', FLAT, V, DISMINUIDA, ASC, 'D'],
  // ['G', FLAT, V, JUSTA, ASC, 'D'],
...
const DSC_TEST_CASES = [
  ...
  // ['A', FLAT, IV, JUSTA, DSC, 'E'],
  // ['A', FLAT, IV, AUMENTADA, DSC, 'E'],
  // ['A', FLAT, V, DISMINUIDA, DSC, 'D'],
  // ['A', FLAT, V, JUSTA, DSC, 'D'],
  // ['A', FLAT, V, AUMENTADA, DSC, 'D'],
  // ['A', FLAT, VI, m, DSC, 'C'],
  // ['A', FLAT, VI, M, DSC, 'C'],
  // ['A', FLAT, VII, m, DSC, 'B'],
  // ['A', FLAT, VII, M, DSC, 'B'],
  ...
  // ['G', FLAT, IV, JUSTA, DSC, 'D'],
  // ['G', FLAT, IV, AUMENTADA, DSC, 'D'],
  // ['G', FLAT, V, DISMINUIDA, DSC, 'C'],
  // ['G', FLAT, V, JUSTA, DSC, 'C'],
  // ['G', FLAT, V, AUMENTADA, DSC, 'C'],
  // ['G', FLAT, VI, m, DSC, 'B'],
  // ['G', FLAT, VI, M, DSC, 'B'],
  // ['G', FLAT, VII, m, DSC, 'A'],
  // ['G', FLAT, VII, M, DSC, 'A'],
  ['G', NATURAL, II, m, DSC, 'F'],
  ['G', NATURAL, II, M, DSC, 'Fb'],
...
// const CHALLENGE_CASES = ASC_TEST_CASES
      ...
      Object.values(SHIFTS).forEach((shift) => {
        Object.values(INTERVALS).forEach((interval) => {
          ...
          Object.values(intervalOptions).forEach((intervalQuality) => {
            acc.push([note, shift.name, interval, intervalQuality.name, direction, '<EXPECTED>'])
          })
        })
      })
    })
